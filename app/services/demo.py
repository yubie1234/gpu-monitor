        ...
        {"name": "gpu-node-02", "ready": True, "product": "H100",
         ...
         "allocations": [
             ...
             {"namespace": "kserve", "pod": "llama3-8b-eval-predictor-6c8b9-abcde",
              ...
              "ready": True},
             {"namespace": "team-ml", "pod": "integration-test-run-7k2m9",
              "workload": "integration-test", "workload_type": "Job",
              "purpose": "batch", "environment": "test", "gpu": 1, "ready": True}]},
